    ...
    <div class="col-md-8">
      <div class="box box-info">
        <div class="box-header with-border">
          <h2 class="box-title"><?php echo $_REQUEST['docform']; ?></h2>
        </div>
        <div class="box-body">
        <form role="form" method="POST" enctype="multipart/form-data" name="add_name" id="add_name"> <!-- action="_send_document.php" -->
          <div class="row">
            <div class="col-md-6">
              <?php
              ...
              <!-- <div class="form-group">
                ...
                <input type="hidden" name="docform" value="<?php echo $row['doc_title']; ?>">
              <!-- </div> -->
            </div>
          </div>
          <!-- <div class="row">
              ...
              ?>
                ...
                <tr>
                  <td>
                    ...
                    <input type="hidden" class="form-control" name="ds_sendh[]" value="<?php echo $row['text_title']; ?>">
                  </td>
                </tr>
                <?php } ?>
                ...
                <tr>
                  <td>
                    <input type="text" class="form-control" name="ds_send[]" placeholder="Enter Detail">
                  </td>
                </tr>
                <?php } ?>
                ...
                <tr>
                  <td>
                    <textarea type="text" name="ds_send[]" rows="4" cols="50" class="form-control"></textarea><br>
                  </td>
                </tr>
                <?php } ?>
                ...
                <tr>
                  <td>
                    <input type="file" name="ds_send[]" rows="4" cols="50" class="form-control"><br>
                  </td>
                </tr>
                <?php } ?>
                ...
                <tr>
                  <td>
                    <input type="radio" id="rao" name="ds_send[]" value="<?php echo $row['text_title']; ?>">&nbsp&nbsp&nbsp&nbsp&nbsp
                ...
                <tr>
                  <td>
                    <input type="checkbox" id="chkbox" name="ds_send[]" value="<?php echo $row['text_title']; ?>">&nbsp&nbsp&nbsp&nbsp&nbsp
        ...
        <div class="box-footer">
          <button type="button" name="submit" id="submit" class="btn btn-primary pull-right fa fa-download"> Send</button> 
        </div>
      </form>
      </div>
    </div>
